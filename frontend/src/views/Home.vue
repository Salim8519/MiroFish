    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a paragraph of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world with up to <span class="highlight-orange">1 million Agents</span> based on the reality seeds within. Through the god's eye view, inject variables to find the <span class="highlight-code">"local optimum"</span> in complex group interactions under dynamic environments
            </p>
            <p class="slogan-text">
              Let the future be rehearsed in the Agent swarm, let decisions prevail after countless battles<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby, you can upload multiple unstructured data files to initialize the simulation sequence
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relationship extraction & persona generation & env config agent injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse requirements & dynamic temporal updates</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent has rich tools for deep interaction with post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any character in the simulation world & chat with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirement in natural language (e.g., if Wuhan University issues a notice revoking Xiao's punishment, what public opinion trend will it trigger)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
